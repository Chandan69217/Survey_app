...
class WithoutConstituencyResponseScreen extends StatefulWidget {
  ...
  WithoutConstituencyResponseScreen({super.key,required this.queryId,this.onResponseAdd,this.initialRespoCount = 0});
  @override
  State<WithoutConstituencyResponseScreen> createState() => _WithoutConstituencyResponseScreenState();
}

class _WithoutConstituencyResponseScreenState extends State<WithoutConstituencyResponseScreen> with SingleTickerProviderStateMixin{
            ...
            children: [
              ...
              if(_showFeedbackForm)...[
                SizeTransition(
                  ...
                  child: Column(
                    children: [
                      WithoutConstituencyFeedbackForm(
  ...
  Future<void> _getResponse()async{
    try{
      final uri = Uri.https(
        Urls.baseUrl,
        '/api/soultion-query/${widget.queryId}/public-create/list/',
        {
...
class WithoutConstituencyFeedbackForm extends StatefulWidget {
  final String queryId;
  final Map<String,dynamic>? recentReview;

  const WithoutConstituencyFeedbackForm({super.key,required this.queryId,this.recentReview});

  @override
  State<WithoutConstituencyFeedbackForm> createState() => _WithoutConstituencyFeedbackFormState();
}

class _WithoutConstituencyFeedbackFormState extends State<WithoutConstituencyFeedbackForm> {
  ...
  void _onSubmit()async {
    ...
    try{
      final url = Uri.https(Urls.baseUrl,'/api/soultion-query/${widget.queryId}/public-create/');
